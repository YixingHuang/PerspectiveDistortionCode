...
def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256, use_wandb=False, isTiff=None):
    ...
    for label, im_data in visuals.items():
        if isTiff:
            ...
            im = util.tensor2im_tiff(im_data)
...
class Visualizer():
    ...
    def print_current_losses_train(self, losses):
        """print current losses on console; also save the losses to the disk
    ...
    def print_current_losses_train2(self, loss):
        """print current losses on console; also save the losses to the disk
    ...
    def print_current_losses_val(self, losses):
        """print current losses on console; also save the losses to the disk
